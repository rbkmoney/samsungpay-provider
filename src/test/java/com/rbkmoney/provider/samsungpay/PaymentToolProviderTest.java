...
public class PaymentToolProviderTest {
    ...
    public void testUnwrapPaymentTool() throws Exception {
        ...
        UnwrappedPaymentTool unwrappedPaymentTool = client.unwrap(new WrappedPaymentTool(PaymentRequest.samsung(new SamsungPayRequest("bb12a068ebca4916a7c3c1", "abf930ba74fe4231b2e2cd"))));
